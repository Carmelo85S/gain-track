...
const ManWorkout = () => {
  ...
  return (
    <div className="xs:bg-black">
      <div className="fixed top-0 left-0 w-full h-[50vh] flex justify-center items-center z-10">
        <img
          src={ManWorkoutGraphic}
          alt="man workout graphic"
          className="w-full h-full object-cover"
        />
        <div className="absolute top-64 transform -translate-y-1/2 text-center">
