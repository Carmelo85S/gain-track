...
const Home = () => {
  ...
  return (
    <div className="md:hidden xs:bg-main-bg xs:bg-no-repeat xs:bg-center xs:bg-cover xs:max-w-full xs:w-full xs:min-h-screen xs:flex xs:flex-col xs:justify-center xs:items-center xs:overflow-hidden">
